...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch){
            case COURSES:
                //vnd.android.cursor.dir/vnd.com.example.android.notekeeper.provider.courses
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch){
            case NOTES:
                ...
                //content://com.example.android.notekeeper.provider/notes/1
            ...
            case COURSES:
                ...
                break;
            case NOTES_EXPANDED:
                //throw exception saying thid is only a read-only table
                break;
        }
